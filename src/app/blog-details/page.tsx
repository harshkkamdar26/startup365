...
export const metadata: Metadata = {
  title: "Página de detalhes do blog | Modelo Next.js gratuito para startups e SaaS",
  description: "Esta é a página de detalhes do blog para o modelo Startup Nextjs",
  // other metadata
};
